...
def handle_navigation(req):
	...
	os.system("rosrun map_server map_server /home/ubuntu/ROS/nautonomous_ws4/src/WaternetNautonomous/WaternetNautonomousNavigation/nautonomous_navigation_navigate/scripts/amsterdam.yaml&")
	os.system("")
...
if __name__ == "__main__":
	...
	G = nx.Graph()
	v = []
	with open('/home/ubuntu/ROS/nautonomous_ws4/src/WaternetNautonomous/WaternetNautonomousNavigation/nautonomous_navigation_navigate/scripts/intersections.json') as data_file:    
