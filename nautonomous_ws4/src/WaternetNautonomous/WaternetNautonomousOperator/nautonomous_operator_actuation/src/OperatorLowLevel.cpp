...
int main(int argc, char **argv) {
	...
	//Subscribe to topics for the operator propulsion, conveyor and lighting
	...
	//Subscrive to manual operators RC and bluetooth
	...
	//Publish topics for manual propulsion, conveyor and lighting
