...
(cl:defclass <MissionFeedback> (roslisp-msg-protocol:ros-message)
  ((feedback
    :reader feedback
    :initarg :feedback
    :type nautonomous_operation_action_client-msg:Status
    :initform (cl:make-instance 'nautonomous_operation_action_client-msg:Status)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nautonomous_operation_action_client-msg:<MissionFeedback> is deprecated: use nautonomous_operation_action_client-msg:MissionFeedback instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionFeedback>)))
  ...
  "nautonomous_operation_action_client/MissionFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionFeedback)))
  "Returns string type for a message object of type 'MissionFeedback"
  "nautonomous_operation_action_client/MissionFeedback")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#feedback~%nautonomous_operation_action_client/Status feedback~%~%================================================================================~%MSG: nautonomous_operation_action_client/Status~%int32 progression~%string status~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionFeedback)))
  "Returns full string definition for message of type 'MissionFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#feedback~%nautonomous_operation_action_client/Status feedback~%~%================================================================================~%MSG: nautonomous_operation_action_client/Status~%int32 progression~%string status~%~%"))
