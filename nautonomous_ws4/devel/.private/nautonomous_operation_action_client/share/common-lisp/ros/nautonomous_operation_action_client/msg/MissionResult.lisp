...
(cl:defmethod cl:initialize-instance :after ((m <MissionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nautonomous_operation_action_client-msg:<MissionResult> is deprecated: use nautonomous_operation_action_client-msg:MissionResult instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionResult>)))
  ...
  "nautonomous_operation_action_client/MissionResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionResult)))
  "Returns string type for a message object of type 'MissionResult"
  "nautonomous_operation_action_client/MissionResult")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result definition~%nautonomous_operation_action_client/Status result~%~%================================================================================~%MSG: nautonomous_operation_action_client/Status~%int32 progression~%string status~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionResult)))
  "Returns full string definition for message of type 'MissionResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result definition~%nautonomous_operation_action_client/Status result~%~%================================================================================~%MSG: nautonomous_operation_action_client/Status~%int32 progression~%string status~%~%"))
