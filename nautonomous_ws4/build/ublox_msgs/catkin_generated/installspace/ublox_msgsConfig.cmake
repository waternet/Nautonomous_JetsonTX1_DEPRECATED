...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/ROS/nautonomous_ws4/install/${idir}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>' to fix it.")
    endif()
